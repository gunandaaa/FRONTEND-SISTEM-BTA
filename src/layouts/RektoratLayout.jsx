...
function RektoratLayout() {
  ...
  return (
    // Menggunakan h-screen agar layout tidak terpotong
    <div className="h-screen w-full bg-gray-50 flex font-sans text-bta-black overflow-hidden relative">
      ...
      >
        ...
        <div className="p-6 md:p-8 border-b border-white/10 flex justify-between items-center">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-bta-yellow text-xs font-bold uppercase tracking-wider mt-0.5">Rektorat</p>
            </div>
          </div>
        ...
        <nav className="p-5 space-y-2 flex-1 overflow-y-auto">
          <NavLink to="/rektorat/dashboard" onClick={closeMobileSidebar} className={menuClass}>
            Dashboard Eksekutif
          </NavLink>

          <NavLink to="/rektorat/laporan-akademik" onClick={closeMobileSidebar} className={menuClass}>
            Laporan Akademik
          </NavLink>

          <NavLink to="/rektorat/laporan-keuangan" onClick={closeMobileSidebar} className={menuClass}>
            Laporan Keuangan
          </NavLink>
        </nav>
        ...
        <header className="bg-white shadow-sm px-4 md:px-8 py-4 md:py-5 flex justify-between items-center z-10 border-b border-gray-100">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-gray-500 text-xs md:text-sm font-medium mt-0.5">Panel Eksekutif Rektorat</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4">
            <div className="text-right hidden sm:block">
              <p className="font-extrabold text-gray-800 tracking-tight">Pimpinan</p>
