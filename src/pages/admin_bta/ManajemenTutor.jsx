          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-gray-50/80 border-b border-gray-100">
                <th className="px-8 py-5 text-xs uppercase tracking-wider font-black text-[#0F4C3A] w-16">No</th>
                <th className="px-8 py-5 text-xs uppercase tracking-wider font-black text-[#0F4C3A]">Nama Tutor</th>
                <th className="px-8 py-5 text-xs uppercase tracking-wider font-black text-[#0F4C3A]">Email / Username</th>
                <th className="px-8 py-5 text-xs uppercase tracking-wider font-black text-[#0F4C3A]">Status</th>
                <th className="px-8 py-5 text-xs uppercase tracking-wider font-black text-[#0F4C3A] text-right">Aksi</th>
              </tr>
            </thead>
